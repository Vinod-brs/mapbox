        ...
        <div className="d-flex flex-grow-1">
          ...
          <div className="flex-grow-1">
            ...
            <div className="d-flex ps-3 align-items-center">
              <div className="flex-grow-1">
                <h4 className='mb-0'>Mapbox API</h4>
                <p className="p-0 m-0 text-start"><b>Purpose: Mapbox API is a location data platform to add maps to the websites and search for places.</b></p>
                
                <p className="p-0 m-0 text-start"> <a href="https://github.com/Vinod-brs/mapbox" target="_blank " > <img src="https://vinod-brs.github.io/Tic-Tac-Toe/assets/img/noun-link.png" className="link" alt="" /> Git Repository</a></p>
                <p className="p-0 mt-1 mb-1 text-start"> <a href="https://www.mapbox.com/" target="_blank " > <img src="https://vinod-brs.github.io/Tic-Tac-Toe/assets/img/noun-link.png" className="link" alt="" /> https://www.mapbox.com/</a></p>
              </div>
            </div>
          </div>
        </div>
